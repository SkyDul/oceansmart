...
import { Mail, Lock, LogIn, Anchor, CheckCircle } from 'lucide-react';
    ...
    <div style={{
      ...
      <div className="light-glass-card" style={{
        ...
        <div style={{ flex: 1, background: 'linear-gradient(135deg, #023e8a, #0096c7)', padding: '3rem', color: '#fff', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <h1 style={{ fontSize: '2.5rem', fontWeight: 800, lineHeight: 1.2, marginBottom: '1rem' }}>Selamat Datang</h1>
          <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.85)', lineHeight: 1.6, marginBottom: '2rem' }}>Portal terpadu untuk konservasi laut cerdas. Pantau kualitas air dan selamatkan terumbu karang bersama OceanSmart.</p>
        ...
        <div style={{ flex: '1.2', padding: '3rem', background: '#ffffff', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#0f172a', marginBottom: '0.25rem' }}>Login ke Akun Anda</h2>
          <p style={{ color: '#64748b', fontSize: '0.875rem', marginBottom: '2rem' }}>Akses panel monitoring dan fitur OceanSmart.</p>

          {successMsg && (
            <div style={{ padding: '0.6rem', background: '#dcfce7', border: '1px solid #bbf7d0', borderRadius: '0.5rem', color: '#15803d', fontSize: '0.75rem', marginBottom: '1rem', textAlign: 'center', fontWeight: 500 }}>
              {successMsg}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, color: '#334155', marginBottom: '0.4rem', textTransform: 'uppercase', letterSpacing: 0.5 }}>
                Alamat Email
              </label>
              <div style={{ position: 'relative' }}>
                ...
                <input 
                  ...
                  style={{
                    ...
                    borderRadius: '0.625rem', color: '#0f172a', fontSize: '0.875rem',
