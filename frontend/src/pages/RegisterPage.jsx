...
import { Anchor, Lock, UserPlus, User, Mail, Eye, EyeOff, Home } from 'lucide-react';
  ...
  const registerWithGoogle = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        setIsLoading(false);
        navigate('/login', { state: { message: 'Registrasi Google berhasil! Silakan masuk.' } });
      } catch (err) {
        setIsLoading(false);
        setErrorMsg(err.response?.data?.detail || 'Registrasi Google gagal.');
      }
    },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Bottom text */}
          <div style={{ position: 'relative', zIndex: 1 }}>
            <h2 style={{ color: '#fff', fontSize: '1.375rem', fontWeight: 800, lineHeight: 1.3, margin: '0 0 0.75rem' }}>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '1.75rem' }}>
            ...
            <p style={{ color: '#64748b', fontSize: '0.875rem', margin: 0 }}>
              Daftar sebagai pengguna platform OceanSmart
            </p>
          </div>
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <button type="submit" disabled={isLoading}
              style={{
                ...
                opacity: isLoading ? 0.85 : 1, transition: 'opacity 0.2s',
            ...
            >
              {isLoading
                ...
                : <><span>Daftar Sekarang</span><UserPlus size={16} /></>
              }
            </button>
          </form>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '1.25rem', paddingTop: '1rem', borderTop: '1px solid #f1f5f9' }}>
            <span style={{ fontSize: '0.8125rem', color: '#64748b' }}>
              Sudah punya akun? <Link to="/login" style={{ color: '#0077b6', fontWeight: 700, textDecoration: 'none' }}>Masuk</Link>
            </span>
            <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 5, fontSize: '0.8125rem', color: '#64748b', textDecoration: 'none', fontWeight: 500, transition: 'color 0.15s' }}
